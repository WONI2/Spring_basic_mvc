    ...
    <script>
        ...
        $idInput.onkeyup = e => {
            ...
            if(idValue.trim() === '') {
                ...
                document.getElementById('idChk').innerHTML = '<b style = "color: red">[아이디는 필수값 입니다!]</b>';
                checkResultList[0]= false;
            }else if(!accountPattern.test(idValue)) {
                $idInput.style.borderColor='red';
                document.getElementById('idChk').innerHTML = '<b style = "color: red">[아이디는 4~14 글자의 영문, 숫자로 입력하세요!]</b>';
                checkResultList[0]= false;
            }else {
                ...
                .then(flag => {
                    if(flag){
                        $idInput.style.borderColor='red';
                         document.getElementById('idChk').innerHTML = '<b style = "color: red">[아이디가 중복되었습니다!]</b>';
                         checkResultList[0] =false;
                        }else {
                        $idInput.style.borderColor='blue';
                        document.getElementById('idChk').innerHTML = '<b style = "color: blue">[사용가능한 아이디 입니다]</b>';
